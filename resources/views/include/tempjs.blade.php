    ...
    <!-- jQuery  -->
		<script type="text/javascript" src="HTML/js/jquery-1.11.2.min.js"></script>
    ...
    <script type="text/javascript" src="HTML/js/masonry.pkgd.min.js"></script>
    
    <!-- COUNTER -->
    <script type="text/javascript" src="HTML/js/jquery.countTo.js"></script>
