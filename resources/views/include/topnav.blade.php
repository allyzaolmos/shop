    ...
    <a href="/index" class="clearfix">
      ...
      <div class="main-menu-container">
        ...
        <li class="parent current">
          <a href="/index"><div class="main-menu-title">HOME</div></a>
          </li>

        <!-- MENU ITEM -->
        <li class="parent">
          <a href="#"><div class="main-menu-title">MY ACCOUNT</div></a>
        </li>					
        ...
        <!-- MENU ITEM -->
        <li class="parent">
          <a href="/login"><div class="main-menu-title">LOGIN</div></a>
        ...
        <!-- MENU ITEM -->
        <li id="menu-cart" >
          <a href="#"><div class="main-menu-title"><span aria-hidden="true" class="icon_cart"></span>CART (0)</div></a>
        </li>
